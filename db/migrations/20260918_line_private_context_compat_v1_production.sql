...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM private_line.schema_migration WHERE version='20260918_line_private_conversation_security_v1_production' AND checksum='sha256:be2942e075f2beaca66619c72e2b28684c82ce1c950fa7bd9ba5bcda8049c534') THEN RAISE EXCEPTION 'security patch missing'; END IF;
  PERFORM pg_advisory_xact_lock(hashtext('private_line:20260918_line_private_context_compat_v1'));
  SELECT checksum INTO existing_checksum FROM private_line.schema_migration WHERE version='20260918_line_private_context_compat_v1_production';
...
-- checksum-source-end
INSERT INTO private_line.schema_migration(version,checksum) VALUES('20260918_line_private_context_compat_v1_production','sha256:83c0b6c89014bd11cf3e1aa51d4b7ce0233bfce62b33d594a397514c02e832a0') ON CONFLICT(version) DO NOTHING;
COMMIT;
