...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM private_line.schema_migration WHERE version='20260918_line_private_conversation_v1_uat' AND checksum='sha256:d208639906275865acb686cb0d0039e14a9feb3dcd7a2156702f45b061c34344') THEN RAISE EXCEPTION 'private conversation base missing'; END IF;
  PERFORM pg_advisory_xact_lock(hashtext('private_line:20260918_line_private_conversation_security_v1'));
  SELECT checksum INTO existing_checksum FROM private_line.schema_migration WHERE version='20260918_line_private_conversation_security_v1_uat';
...
-- checksum-source-end
INSERT INTO private_line.schema_migration(version,checksum) VALUES('20260918_line_private_conversation_security_v1_uat','sha256:be2942e075f2beaca66619c72e2b28684c82ce1c950fa7bd9ba5bcda8049c534') ON CONFLICT(version) DO NOTHING;
COMMIT;
