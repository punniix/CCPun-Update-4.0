...
BEGIN
  ...
  IF NOT EXISTS(SELECT 1 FROM private_line.schema_migration WHERE version='20260918_line_privacy_retention_v2_uat' AND checksum='sha256:ce3a55a27969b4effecb70af0bc8f5e4de4f9dc023fbd32fc91ded69a08005f8') THEN RAISE EXCEPTION 'privacy retention v2 missing'; END IF;
  ...
  SELECT checksum INTO existing_checksum FROM private_line.schema_migration WHERE version='20260918_line_conversation_archive_v1_uat';
...
VALUES('20260918_line_conversation_archive_v1_uat','sha256:15d047b231bd18214f5e47ce4382033e5cd7786811006e3dfa217d0db32f8fef')
