...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM private_line.schema_migration WHERE version='20260918_line_key_rotation_v2_uat' AND checksum='sha256:3884446394a191afdfbde544f4b6e887fd996732d6705956ac7fc0efda7fc21d') THEN RAISE EXCEPTION 'previous LINE migration missing'; END IF;
  ...
  SELECT checksum INTO existing_checksum FROM private_line.schema_migration WHERE version='20260918_line_attribution_privacy_ops_v1_uat';
...
-- checksum-source-end
INSERT INTO private_line.schema_migration(version,checksum) VALUES('20260918_line_attribution_privacy_ops_v1_uat','sha256:4d8552c0f3a44407733a7a396a36909e4cc87c657e8d0c39a8d5e818e7f5875b') ON CONFLICT(version) DO NOTHING;
COMMIT;
