...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM private_line.schema_migration WHERE version='20260918_line_attribution_privacy_ops_fix_v1_production' AND checksum='sha256:966f039cbf412946528136a5c1b9ebf04ce98027d5f2a15ea1820a63d189a2b2') THEN RAISE EXCEPTION 'attribution/privacy fix missing'; END IF;
  ...
  SELECT checksum INTO existing_checksum FROM private_line.schema_migration WHERE version='20260918_line_document_media_activation_v1_production';
...
-- checksum-source-end
INSERT INTO private_line.schema_migration(version,checksum) VALUES('20260918_line_document_media_activation_v1_production','sha256:fcab7e746a62850711493cfa849548975c6dfdb8365417d3b142fdc26ae1026f') ON CONFLICT(version) DO NOTHING;
COMMIT;
