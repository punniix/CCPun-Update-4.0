...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM private_line.schema_migration WHERE version='20260917_private_line_runtime_v1_production' AND checksum='sha256:f562ba174f50cf617d0e12ffd13c46e5815b069dc823ecb7c8522d7b05d6c57b') THEN RAISE EXCEPTION 'base private_line mismatch'; END IF;
  IF NOT EXISTS (SELECT 1 FROM private_line.schema_migration WHERE version='20260918_line_advisor_inbox_v1_production' AND checksum='sha256:99519369562761cfb4cb95fe7d6e14f5d0a158ba31b116200d729eb865a451e0') THEN RAISE EXCEPTION 'advisor inbox base missing'; END IF;
  ...
  SELECT checksum INTO existing_checksum FROM private_line.schema_migration WHERE version='20260918_line_private_conversation_v1_production';
...
INSERT INTO private_line.schema_migration(version,checksum) VALUES('20260918_line_private_conversation_v1_production','sha256:d208639906275865acb686cb0d0039e14a9feb3dcd7a2156702f45b061c34344') ON CONFLICT(version) DO NOTHING;
