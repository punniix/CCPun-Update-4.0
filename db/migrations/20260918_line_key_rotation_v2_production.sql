...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM private_line.schema_migration WHERE version='20260918_line_safe_knowledge_crm_campaign_v1_production' AND checksum='sha256:099a8968a8ec6fbb1fee589b410f3f071e762dd86ef3b1906b903fed5029e68d') THEN RAISE EXCEPTION 'previous LINE migration missing'; END IF;
  ...
  SELECT checksum INTO existing_checksum FROM private_line.schema_migration WHERE version='20260918_line_key_rotation_v2_production';
...
-- checksum-source-end
INSERT INTO private_line.schema_migration(version,checksum) VALUES('20260918_line_key_rotation_v2_production','sha256:3884446394a191afdfbde544f4b6e887fd996732d6705956ac7fc0efda7fc21d') ON CONFLICT(version) DO NOTHING;
COMMIT;
