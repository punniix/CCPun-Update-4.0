...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM private_line.schema_migration WHERE version='20260918_line_delivery_activation_v1_uat' AND checksum='sha256:0ae7539cbc55299979f1821984875181e66259efec4ddc16cc3e549a056eabfa') THEN RAISE EXCEPTION 'delivery activation missing'; END IF;
  ...
  SELECT checksum INTO existing_checksum FROM private_line.schema_migration WHERE version='20260918_line_content_intelligence_v2_uat';
...
-- checksum-source-end
INSERT INTO private_line.schema_migration(version,checksum) VALUES('20260918_line_content_intelligence_v2_uat','sha256:084d1063b0d0fbc1c48762ea8de88994210f7d063f244874c2b17c5ff55147af') ON CONFLICT(version) DO NOTHING;
COMMIT;
