SELECT
  EXISTS(SELECT 1 FROM private_line.schema_migration WHERE version='20260918_line_delivery_activation_v1_uat' AND checksum='sha256:0ae7539cbc55299979f1821984875181e66259efec4ddc16cc3e549a056eabfa') AS migration_checksum_ok,
