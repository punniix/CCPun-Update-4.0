...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM private_line.schema_migration WHERE version='20260918_line_private_inbox_reader_v1_production' AND checksum='sha256:48d5ebc7084f38f6a4e9bdb5ff4f72b1a7ba9bfc42f8356f6fbfd59ee0607c1c') THEN RAISE EXCEPTION 'previous LINE migration missing'; END IF;
  ...
  SELECT checksum INTO existing_checksum FROM private_line.schema_migration WHERE version='20260918_line_safe_knowledge_crm_campaign_v1_production';
...
INSERT INTO private_line.schema_migration(version,checksum) VALUES('20260918_line_safe_knowledge_crm_campaign_v1_production','sha256:099a8968a8ec6fbb1fee589b410f3f071e762dd86ef3b1906b903fed5029e68d') ON CONFLICT(version) DO NOTHING;
COMMIT;
