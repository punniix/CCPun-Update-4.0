SELECT
 EXISTS(SELECT 1 FROM private_line.schema_migration WHERE version='20260918_line_private_inbox_reader_v1_uat' AND checksum='sha256:48d5ebc7084f38f6a4e9bdb5ff4f72b1a7ba9bfc42f8356f6fbfd59ee0607c1c') AS inbox_reader_checksum_ok,
