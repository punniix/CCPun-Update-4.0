...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM private_line.schema_migration WHERE version='20260918_line_attribution_privacy_ops_v1_production' AND checksum='sha256:4d8552c0f3a44407733a7a396a36909e4cc87c657e8d0c39a8d5e818e7f5875b') THEN RAISE EXCEPTION 'attribution/privacy base missing'; END IF;
  PERFORM pg_advisory_xact_lock(hashtext('private_line:20260918_line_attribution_privacy_ops_fix_v1'));
  SELECT checksum INTO existing_checksum FROM private_line.schema_migration WHERE version='20260918_line_attribution_privacy_ops_fix_v1_production';
...
-- checksum-source-end
INSERT INTO private_line.schema_migration(version,checksum) VALUES('20260918_line_attribution_privacy_ops_fix_v1_production','sha256:966f039cbf412946528136a5c1b9ebf04ce98027d5f2a15ea1820a63d189a2b2') ON CONFLICT(version) DO NOTHING;
COMMIT;
