...
BEGIN
  ...
  END IF;
  PERFORM pg_advisory_xact_lock(hashtext('private_line:20260917_private_line_runtime_v1_production'));
  ...
  IF current_checksum IS NOT NULL AND current_checksum <> 'sha256:f562ba174f50cf617d0e12ffd13c46e5815b069dc823ecb7c8522d7b05d6c57b' THEN
...
CREATE TABLE IF NOT EXISTS private_line.system_identity (
  ...
  migration_version text NOT NULL CHECK (migration_version = '20260917_private_line_runtime_v1_production'),
...
VALUES ('20260917_private_line_runtime_v1_production', 'sha256:f562ba174f50cf617d0e12ffd13c46e5815b069dc823ecb7c8522d7b05d6c57b')
...
INSERT INTO private_line.system_identity (
  ...
  'neondb',
  '20260917_private_line_runtime_v1_production',
  'sha256:f562ba174f50cf617d0e12ffd13c46e5815b069dc823ecb7c8522d7b05d6c57b'
