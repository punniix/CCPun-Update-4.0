...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    RAISE EXCEPTION 'Base private_line UAT migration is missing or mismatched';
  END IF;
  IF NOT EXISTS (
    ...
    RAISE EXCEPTION 'Base private_line UAT identity is missing or mismatched';
  END IF;
...
VALUES ('20260918_line_advisor_inbox_v1_uat', 'sha256:99519369562761cfb4cb95fe7d6e14f5d0a158ba31b116200d729eb865a451e0')
