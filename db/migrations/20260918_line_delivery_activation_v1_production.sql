...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM private_line.schema_migration WHERE version='20260918_line_document_media_activation_v1_production' AND checksum='sha256:fcab7e746a62850711493cfa849548975c6dfdb8365417d3b142fdc26ae1026f') THEN RAISE EXCEPTION 'document/media activation missing'; END IF;
  ...
  SELECT checksum INTO existing_checksum FROM private_line.schema_migration WHERE version='20260918_line_delivery_activation_v1_production';
...
-- checksum-source-end
INSERT INTO private_line.schema_migration(version,checksum) VALUES('20260918_line_delivery_activation_v1_production','sha256:0ae7539cbc55299979f1821984875181e66259efec4ddc16cc3e549a056eabfa') ON CONFLICT(version) DO NOTHING;
COMMIT;
