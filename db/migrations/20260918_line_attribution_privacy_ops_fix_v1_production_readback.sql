SELECT
 EXISTS(SELECT 1 FROM private_line.schema_migration WHERE version='20260918_line_attribution_privacy_ops_fix_v1_production' AND checksum='sha256:966f039cbf412946528136a5c1b9ebf04ce98027d5f2a15ea1820a63d189a2b2') AS fix_checksum_ok,
