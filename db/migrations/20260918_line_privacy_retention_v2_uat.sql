...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM private_line.schema_migration WHERE version='20260918_line_content_intelligence_v2_uat' AND checksum='sha256:084d1063b0d0fbc1c48762ea8de88994210f7d063f244874c2b17c5ff55147af') THEN RAISE EXCEPTION 'content intelligence v2 missing'; END IF;
  ...
  SELECT checksum INTO existing_checksum FROM private_line.schema_migration WHERE version='20260918_line_privacy_retention_v2_uat';
...
-- checksum-source-end
INSERT INTO private_line.schema_migration(version,checksum) VALUES('20260918_line_privacy_retention_v2_uat','sha256:ce3a55a27969b4effecb70af0bc8f5e4de4f9dc023fbd32fc91ded69a08005f8') ON CONFLICT(version) DO NOTHING;
COMMIT;
