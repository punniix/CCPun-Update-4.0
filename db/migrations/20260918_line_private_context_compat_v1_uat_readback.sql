SELECT
 EXISTS(SELECT 1 FROM private_line.schema_migration WHERE version='20260918_line_private_context_compat_v1_uat' AND checksum='sha256:83c0b6c89014bd11cf3e1aa51d4b7ce0233bfce62b33d594a397514c02e832a0') AS context_compat_checksum_ok,
