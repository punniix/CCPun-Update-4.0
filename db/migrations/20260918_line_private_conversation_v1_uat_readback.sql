SELECT
 ...
 EXISTS(SELECT 1 FROM private_line.schema_migration WHERE version='20260918_line_private_conversation_v1_uat' AND checksum='sha256:d208639906275865acb686cb0d0039e14a9feb3dcd7a2156702f45b061c34344') AS checksum_ok,
 EXISTS(SELECT 1 FROM private_line.system_identity WHERE singleton=true AND project_id='young-term-47483330' AND branch_id='br-crimson-mouse-az7ajkv8' AND endpoint_id='ep-mute-frost-aztvz394' AND database_name='neondb' AND migration_version='20260917_private_line_runtime_v1_uat' AND migration_checksum='sha256:19a7dfaf26d2cc4f6cbf01d7ff2380056383f8e87dd079a6e141e73b878985d3') AS base_identity_unchanged,
