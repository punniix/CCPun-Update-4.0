SELECT
  EXISTS(SELECT 1 FROM private_line.schema_migration WHERE version='20260918_line_document_media_activation_v1_production' AND checksum='sha256:fcab7e746a62850711493cfa849548975c6dfdb8365417d3b142fdc26ae1026f') AS migration_checksum_ok,
