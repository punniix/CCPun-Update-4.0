...
Website 4.3 responsive layout reference: [`website-43-responsive-layout-contract-20260911.md`](./website-43-responsive-layout-contract-20260911.md). Shared-shell centering, gutters, wide-screen alignment, compensation-removal rules and Figma responsive frames must follow that contract. PR #93 removes the legacy transition/final-polish horizontal compensation that caused left-pinned shells and the Home hero CTA drift, and adds regression guards against reintroduction. The clean Figma Source of Truth contains canonical 390 / 820 / 1440 screens for Home, Blog Archive, Blog Article, Financial Health Check, CI Planning, Privacy, Cookie Policy and 404, plus Foundation / Components / Source of Truth / Responsive QA pages. The latest PR #93 head after this pointer update must still be verified live because this file itself creates a new commit; do not infer deployment success from the previous commit. Treat transition/final-polish rules as component/interpolation layers only; they must not own or counteract page-shell alignment. Treat this as UAT work until live PR/check/deployment state and explicit Production authorization say otherwise.