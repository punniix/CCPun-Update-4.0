    ...
    <div className={styles.root}>
      <main id="main-content" tabIndex={-1}>
        <section id="home" className={styles.homeHero} aria-labelledby="home-hero-title">
          <div className={styles.homeHeroPicture}><Image src="/assets/website-43/home-hero-desktop.png" alt="CCPun กำลังนั่งทำงานพร้อมคอมพิวเตอร์โน้ตบุ๊ก" fill preload loading="eager" fetchPriority="high" sizes="100vw" /></div>
        ...
        <section className={`${styles.section} ${styles.sectionBottomLarge}`} id="faq" data-uat-section="home-faq"><div className={styles.inner}><HomeSectionHeading eyebrow="คำถามที่พบบ่อย" title="ก่อนเริ่มวางแผนกับ CCPun" /><div className={styles.faqList}>{faqs.map(({question,answer})=><details className={styles.faqItem} key={question}><summary className={styles.faqSummary}><span>{question}</span><span className={styles.faqIcon} aria-hidden="true">+</span></summary><p className={styles.faqAnswer}>{answer}</p></details>)}</div><a className={styles.faqCta} href="https://lin.ee/tqLCs4f" target="_blank" rel="noopener noreferrer" data-analytics-location="home_faq">ปรึกษากับ CCPun</a></div></section>
