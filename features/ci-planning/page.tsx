        ...
        <section className={styles.toolStorySection} aria-labelledby="ci-reading-title">
          <div className={styles.inner}>
            ...
            <div className={styles.methodBox}>
              ...
              <p>
                ในขั้นตอนแรก คุณสามารถเพิ่มจำนวนครั้งรักษา/ติดตาม วันที่ผู้ดูแลต้องหยุดงาน กายภาพ อุปกรณ์หรือปรับบ้าน และค่าใช้จ่ายอื่นได้ โดยระบบใช้ข้อมูลอ้างอิงปี 2025–2026 พร้อมแสดงแหล่งข้อมูล และไม่ตั้งยอดก้อนเดียวเป็นค่าเริ่มต้นให้ทุกคน
              </p>
            </div>
